<template>
  ...
  <div class="container content zz">
    ...
    <div class="co-left">
      <!-- 简历吸盘 -->
      <div
        class="me-card carbox borderbefore"
        :class="{ scroll: CardStick }"
        id="mycard"
        ref="mycard"
      >
        ...
        <div class="lianxi-list">
          ...
          <a
            title="email:1457321681@qq.com"
            href="Mailto:1457321681@qq.com?Subject=邮箱标题&amp;Body=邮箱内容！"
          >
            <svg
              t="1649145973361"
              class="icon"
        ...
        <div class="mecar-bottm">
          <div>
            ...
            <span class="mecarbottm-value">武汉城市职业学院</span>
          </div>
          <div>
            <span class="mecarbottm-key">所在城市</span>
            <span class="mecarbottm-value">湖北 武汉</span>
          </div>
          <div>
        ...
        <!-- <div class="carbox li3-box">
          <div class="play-buttom" id="playbuttom">
            <span
              ...
              >
                <path
                  d="M657.92 535.04l-256-160v320z"
                  p-id="20205"
        ...
        <div class="li4-box">
          ...
          <div class="carbox">
            ...
            >
              ...
              ></path>
              <path
                d="M496.64 762.88h40.96v143.36h-40.96z"
                fill="#333333"
                p-id="1851"
              ></path>
            </svg>
          ...
          <div class="carbox">
            ...
            >
              ...
              ></path>
              <path
                d="M574.464 679.936L512 617.984l-62.464 61.952-28.672-28.672 91.136-91.648 91.136 91.648z"
                fill="#EB4446"
                p-id="2004"
              ></path>
              <path
                d="M491.52 614.4h40.96v171.52h-40.96z"
                fill="#EB4446"
                p-id="2005"
              ></path>
              <path
          ...
          <div class="carbox">
            ...
            >
              ...
              ></path>
              <path
                d="M102.4 491.52h814.592v40.96H102.4z"
                fill="#EB4446"
                p-id="2162"
              ></path>
              <path
...
const ScrollStick = () => {
  window.onscroll = function () {
    ...
    if (scrollTop > 100) {
      CardStick.value = true;
    } else {
      CardStick.value = false;
    }
  };
};
</script>
